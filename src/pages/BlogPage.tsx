  ...
  return (
    <div className="min-h-screen bg-background">
      <SeoHead
        ...
        description="Lue asiantuntija-artikkeleita sähköauton akusta, huollosta, kustannuksista ja riskeistä. Ajantasaista tietoa Suomen markkinasta."
      ...
      <div className="pt-28 pb-20 px-6">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-black text-foreground tracking-tight mb-4 animate-fade-up">
            AkkuTurva <span className="text-gradient">blogi</span>
          </h1>
          ...
          <div className="space-y-5">
            {blogPosts.map((post, i) => (
              <Link
                key={post.slug}
                to={`/blogi/${post.slug}`}
                className="block glass-strong rounded-2xl p-6 shadow-premium hover:shadow-premium-lg transition-all duration-300 hover:-translate-y-1 group"
              >
